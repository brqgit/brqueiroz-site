...
const services: ServiceType[] = [
  ...
  },
  {
    ...
    description: "services.project-management.description",
    shortDescription: "services.project-management.shortDescription",
    icon: <Network className="h-10 w-10 text-[#1c5abd]" />,
    image: "/services/project-management.gif",
    fullDescription: "services.project-management.fullDescription"
  }
];
