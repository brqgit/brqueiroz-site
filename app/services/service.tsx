        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <a href="/#servicos" className="inline-block px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
        ...
        <main className="flex min-h-screen flex-col">
            ...
            <section className="bg-[#0a1525] text-white py-16 px-4 md:px-8 lg:px-16 bg-[url('/bg-pattern.svg')] bg-cover bg-center">
                <div className="max-w-7xl mx-auto">
                    <a href="/#servicos" className="inline-flex items-center text-blue-400 hover:text-blue-300 mb-6">
